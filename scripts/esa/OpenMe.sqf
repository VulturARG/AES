...
null = [["marker_0"],[[5,2,150],[0,2,1000],[0,0,1500],[0,1,1500],[0,0,1500],[0,3,1500,600],[0,3,300,5000]],[5,1,EAST,false,false,false],[1,6,600,false,false],360] call Bastion_Spawn;
