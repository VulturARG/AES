...
if (!(getmarkercolor _marker == "colorblack")) then {
    ...
    for "_counter" from 1 to _aGrps do {
        ...
        if (_aMin > 0) then {
            ...
            if (!surfaceiswater _mPos) then {
                ...
                0 = [_aGroup, _marker] call EOS_fnc_taskpatrol;
            };
            ...
            if (_debug) then {
                ...
                0 = [_marker, _counter, "House Patrol", getpos(leader _aGroup)] call EOS_debug
            };
        };
    };
    ...
    from 1 to _bGrps do {
        ...
        if (_bMin > 0) then {
            ...
            0 = [_bGroup, _marker] call EOS_fnc_taskpatrol;
            ...
            if (_debug) then {
                ...
                0 = [_marker, _counter, "patrol", getpos(leader _bGroup)] call EOS_debug
            };
        };
    };
    ...
    for "_counter" from 1 to _cGrps do {
        ...
        0 = [(_cGroup select 2), _marker] call EOS_fnc_taskpatrol;
        ...
        if (_debug) then {
            ...
            0 = [_marker, _counter, "Light Veh", (getpos leader(_cGroup select 2))] call EOS_debug
        };
    };
    ...
    for "_counter" from 1 to _dGrps do {
        ...
        0 = [(_dGroup select 2), _marker] call EOS_fnc_taskpatrol;
        ...
        if (_debug) then {
            ...
            0 = [_marker, _counter, "Armour", (getpos leader(_dGroup select 2))] call EOS_debug
        };
    };
    ...
    for "_counter" from 1 to _eGrps do {
        ...
        if (_debug) then {
            ...
            0 = [_marker, _counter, "Static", (getpos leader(_eGroup select 2))] call EOS_debug
        };
    };
